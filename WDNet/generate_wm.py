...
def generate_watermark_loc(img,root_logo):
...
def generate_watermark_loc2(img,root_logo,seeds):
...
def generate_watermark_tp(img,root_logo,seeds):
...
def generate_watermark_wm(img,root_logo,seeds):
...
def generate_watermark_location(img,root_logo,seeds):
