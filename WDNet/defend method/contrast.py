...
for choose in range(8):
    ...
    for index in range(10):
        ...
        '''compress_clean'''
        wm = transforms.ColorJitter(contrast=choose*0.1)(wm)
        ...
        '''compress'''
        wm_r = transforms.ColorJitter(contrast=choose*0.1)(wm_r)
        ...
        '''compress_adv1'''
        adv1 = transforms.ColorJitter(contrast=choose*0.1)(adv1)
        ...
        '''compress_adv2'''
        adv2 = transforms.ColorJitter(contrast=choose*0.1)(adv2)
