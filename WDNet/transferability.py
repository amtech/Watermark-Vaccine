...
for index in range(200):
    ...
    total_delta2.append(delta2)

    print('='*100)

total_delta1 = torch.stack(total_delta1,1).squeeze(0)
total_delta2 = torch.stack(total_delta2,1).squeeze(0)

torch.save(total_delta1,'delta1_wdnet.pt')
torch.save(total_delta2,'delta2_wdnet.pt')